    ...
    <div className="page" id="projects">
      ...
      <div className="mx-8">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p>
              ...
              ability to update questions and other materials. The department
              also needed to record the responses in a relational database and
              be able to download the data in an Excel file. I used Next.js as
              the frontend, node.js as the backend, Express and Axios for API
              access, and MySQL for the database. I also set up an admin panel
              with proper authentication and a protected page. I used the Papa
              Parse library to convert the response data from JSON to CSV format
              and allowed the administrator to download it.
            </p>
            <h2 className="font-semibold pl-8 my-4">Headlines:</h2>
            <ul className="list-disc pl-14">
              <li>Built a web survey for the Department of Psychology</li>
              <li>
                Allowed for easy updating of questions and other materials
              </li>
        ...
        <div className="card">
          <div className="card-title">
            <h2 className="text-center font-semibold pt-7">
              Dynamic Website for Kennedy Rice Mill
            </h2>
          </div>
          <div className="card-body">
            <h2 className="font-semibold pl-8">Description:</h2>
            <p>
              ...
              Django, a powerful web framework for Python. The website includes
              an admin panel that allows the company to easily update their
              inventory and track user activity. It also features a password
              manager that keeps a log of admin login activity, including date
              and time stamps, and allows for easy password reset. In addition
              to Django, I used a variety of other technologies and tools to
              complete this project, such as HTML, CSS, and JavaScript for the
              front-end, and a variety of libraries and frameworks to support
            ...
            <ul className="list-disc pl-14">
              ...
              <li>
                Wide range of technologies used to delicer top-quality results
                for the client
              </li>
            </ul>
          </div>
